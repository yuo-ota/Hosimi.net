...
class EquatorialCoordsService
    ...
    def calc_equatorial_coords_by_user(latitude, longitude)
    ...
    def get_equatorial_coords_of_moon
    ...
    def get_azimuth_by_horizontal_coords_of_moon
    ...
    def calc_azimuth_right_ascension_diff(moon_azimuth, moon_right_ascension)
        moon_azimuth - moon_right_ascension
    end

    def calc_user_right_ascension(longitude, correction_deg)
        longitude + correction_deg
    end

    # jsonの作成
    def build_location_json(right_ascension, declination)
        location_hash = {
